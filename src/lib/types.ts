...
export type ReceiptCandidate = Tables<"receipt_candidates">;
export type InsertReceiptCandidate = InsertTables<"receipt_candidates">;
export type ReceiptCandidateStatus = ReceiptCandidate["status"];
